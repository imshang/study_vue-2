    ...
    <div class="my-goods-item">
        <div class="left">
         ...
         -->
          ...
          -->
                <input type="checkbox" class="custom-control-input" :id="obj.goods_id" v-model="obj.goods_state">
                <label class="custom-control-label" :for="obj.goods_id">
